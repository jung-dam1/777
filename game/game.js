...
backgroundImg.src = 'background.png'; // 영어 파일명으로 수정
...
playerImg.src = 'player.png'; // 영어 파일명

const cakeImg = new Image();
cakeImg.src = 'cake.png'; // 영어 파일명

// 아이템 이미지 목록
const itemImgs = [
  { name: 'wash', src: 'washitem.png' },
  { name: 'heart', src: 'heartitem.png' },
  { name: 'cook', src: 'cookitem.png' },
  { name: 'book', src: 'bookitem.png' }
];
...
// 이미지 로딩 체크
let imagesLoaded = 0;
const totalImages = 2 + itemImgs.length + 1;
